...
# net_model = readRDS('~/GitHub/NSUM-Simulations/data/initial data/Net_sw.rds')
net_model = readRDS('~/GitHub/NSUM-Simulations/data/initial data/Net_pa.rds')
...
saveRDS(infected.number,'~/GitHub/NSUM-Simulations/data/initial data/hpvector_sw.rds')
saveRDS(infected.number,'~/GitHub/NSUM-Simulations/data/initial data/hpvector_pa.rds')
